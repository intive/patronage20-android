...
class SensorDialogListAdapter(private val onDialogSensorClickListener: (sensor: DialogSensorMock) -> Unit) :
    ListAdapter<List<DialogSensorMock>, SensorDialogViewHolder>(SensorDialogDiffCallback()) {
